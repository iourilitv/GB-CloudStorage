...
//    private ObjectHandler objectHandler;
    ...
    //инициируем объект класса StorageTest
//    private StorageTest storageTest = StorageTest.getOwnInstance();
...
//            connection = new TCPConnection(this, IP_ADDR, PORT);
//            //запускаем тест
//            storageTest.startTest(connection);
//
//        } catch (IOException e) {
//            printMsg("Connection exception: " + e);
//        }
...
//            //инициируем объект обработчика сообщений(команд)
//            ObjectHandler objectHandler = new ObjectHandler(storageTest);
//            //распознаем и обрабатываем полученный объект сообщения(команды)
//            objectHandler.recognizeAndArrangeMessageObject(messageObject);
